...
To specifically examine the transition states following runner on second and no outs, Table 6 was created to filter for only the transition proportions following that state. Looking at this table it can be seen that the next most likely state following a runner on second and no outs is a runner on second with one out (010 1). This state is followed in likelihood by a runner on third with one out (001 1).
