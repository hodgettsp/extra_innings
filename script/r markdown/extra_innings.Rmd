...
Play-by-play files were also examined for missing values; however, all missing values belonged to event-type variables (e.g. the play on runner on second), so these values were not removed as doing so would create issues within the data.
...
```{r, echo=FALSE, fig.align = "center", message=FALSE, warning=FALSE, caption="Home vs. Visitor Wins for Extra-Inning Games and Regulation Length Games for MLB Seasons 2000-2020"}
...
```{r, echo=FALSE, fig.height = 7, fig.width = 9, fig.align = "center", message=FALSE, warning=FALSE, caption="Home vs. Visitor Wins for Regulation Length Games for MLB Seasons 2000-2020"}
...
```{r, echo=FALSE, fig.height = 7, fig.width = 9, fig.align = "center", message=FALSE, warning=FALSE, caption="Home vs. Visitor Wins for Extra-Inning Games for MLB Seasons 2000-2020"}
...
kableExtra::kbl(t3, caption = "Regular Inning Win Count for Home and Visitor by Season") %>% 
  kableExtra::kable_styling(position = "center", latex_options = "HOLD_position", full_width = T) %>% 
...
re24total <- matrix(round(dftotal_joined$avg, 2), 8, 3) %>%
...
##----
# GENERATE PROBAILITY TABLE

# create probability table object from transition matrix
