...
# paste _hi to the end of the index object
for(i in 1:length(t2)){
  t3[i] =  paste0(t2[i], "_runsout")
}

for(i in 1:length(t2)){
  assign(paste0(t2[i], "_runsout"), matrix(round(get(paste0(t2[i], "_runs"))[2], 2), 8, 3))
  dimnames(t3[i])[[2]] <- c("0 outs", "1 out", "2 outs")
  dimnames(t3[i])[[1]] <- c("000", "001", "010", "011",
                            "100", "101", "110", "111")
}
x <- matrix(round(df2016_runs$avg, 2), 8, 3)
dimnames(x)[[2]] <- c("0 outs", "1 out", "2 outs")
dimnames(x)[[1]] <- c("000", "001", "010", "011",
                            "100", "101", "110", "111")
...
for(i in 1:length(t3)){
  assign(paste0(t2[i], "_tmatrix"), dplyr::select(get(t3[i]), 
                                                 state, 
                                                 new_state) %>% 
           table())
}
...
for(i in 1:length(t3)){
  assign(paste0(t2[i], "_pmatrix"), prop.table(get(t3[i]), 1))
